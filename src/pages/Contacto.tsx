    ...
    <div className="contacto">
        ...
        <div className="container">
          ...
          <div className="otras-formas-card" data-aos="fade-up" data-aos-delay="100">
            <div className="contactos-grid">
              {/* Instagram */}
              <div className="contacto-item" data-aos="fade-up" data-aos-delay="150">
              ...
              {/* WhatsApp */}
              <div className="contacto-item" data-aos="fade-up" data-aos-delay="250">
                <div className="contacto-icon">
              ...
              {/* Email */}
              <div className="contacto-item" data-aos="fade-up" data-aos-delay="350">
                <div className="contacto-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section className="cierre-contacto">
        <div className="cierre-contacto-container">
          <div className="cierre-contacto-card" data-aos="fade-up">
            <p>
